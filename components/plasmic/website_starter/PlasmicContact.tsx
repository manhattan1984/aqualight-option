...
import sty from "./PlasmicContact.module.css"; // plasmic-import: 4jED4RlCxA/css
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon12Icon
            className={classNames(projectcss.all, sty.svg__qFvWg)}
            role={"img"}
          />
        ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__uPznt)}>
        <div className={classNames(projectcss.all, sty.freeBox__ndJVy)}>
          {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox___6KKuV)}>
        {p.renderPlasmicSlot({
      ...
      {true ? (
        <div className={classNames(projectcss.all, sty.freeBox__cwCwv)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicLink
                className={classNames(
