...
import sty from "./PlasmicFeature.module.css"; // plasmic-import: xRqDpvXpSd/css

import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: BD_wVlv8Xu/icon
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon2Icon
            className={classNames(projectcss.all, sty.svg__jLmdo)}
            role={"img"}
          />
        ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__fciw7)}>
        <div className={classNames(projectcss.all, sty.freeBox__sjsSb)}>
          {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ap6R)}>
        {p.renderPlasmicSlot({
          defaultContents:
