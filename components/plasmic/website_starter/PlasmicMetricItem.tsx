...
import sty from "./PlasmicMetricItem.module.css"; // plasmic-import: QGkw_mRkJ_/css
...
function PlasmicMetricItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__tZpTn)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <div
              className={classNames(
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lo5Lw)}>
        {p.renderPlasmicSlot({
