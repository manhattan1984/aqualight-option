  ...
  const QA = [
    {
      ...
      answer:
        "Aqualight mining has for years been one of the most trusted and reliable crypto broker company, with our trusted experts that work irelessly to ensure our clients get the most of their investment.",
    },
    {
    ...
    {
      question: "How Can I Start Working With Aqualight mining?",
      answer:
        "First step is to signup on our company, choose an investments plan that best suits you and start earning with Aqualight mining today.",
    },
  ];
  return (
    <div className="min-h-screen pt-8 bg-black text-white">
      <p className=" text-center text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-600">
        FAQs
      </p>
